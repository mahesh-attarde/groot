...
# USE of custom formatter for json file.
#import json,argparse
#import itertools
#from CompactJsonFormatter import CompactJSONEncoder
#def write_dict_to_file(ofname, part):
#    outstream = open(ofname, 'w')
#    json.dump(part, outstream, indent=2, cls=CompactJSONEncoder)
#    outstream.close()
